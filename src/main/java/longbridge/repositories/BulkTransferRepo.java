...
public interface BulkTransferRepo extends CommonRepo<BulkTransfer, Long>{
    ...
    //Page<CreditRequest> getCreditRequests(BulkTransfer bulkTransfer, Pageable pageable);
    //Page<BulkTransferDTO> findByCorporate(Corporate corporate, Pageable details);
