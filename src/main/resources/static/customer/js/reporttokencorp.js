/**
 * Created by Gbeminiyi on 26/05/20220.
 */
...
function validateUsername(user){
    ...
    $.ajax({
        type:'GET',
        url:"/rest/corporate/username/"+user,
        async:false,
    ...
    if(username == "" || username === null || username == "false"){
        ...
        $.ajax({
            url: "/rest/corp/getSecQues/"+username,
            type: 'GET',
            async: false,
...
function validateSecAnswer(secAnswer, username){
    ...
    $.ajax({
        type:'GET',
        url:"/rest/corporate/secAnswer/"+secAnswer+"/"+username,
        async:false,
        success:function(data1){
            result = ''+String(data1);
    ...
    if(result == "" || result === null || result == "false"){
        ...
        $.ajax({
            url: "/rest/corporate/getTokenSerials/"+username,
            type: 'GET',
            async: false,
            success:function(data2){
                tokens = data2;
